...
#define RCCallBottomGradientHeight (self.view.safeAreaTop > 0 ? 242.0f : 208.0f)
...
- (void)viewDidLoad {
    ...
    self.backgroundView.backgroundColor = [UIColor colorWithRed:0.949 green:0.949 blue:0.949 alpha:1.0];
    ...
    self.blurView.backgroundColor = [UIColor colorWithRed:0.949 green:0.949 blue:0.949 alpha:1.0];
...
- (UIButton *)minimizeButton {
    if (!_minimizeButton) {
        _minimizeButton = [[UIButton alloc] init];
        _minimizeButton.frame = CGRectMake(RCCallHorizontalMargin,
                                           RCCallMiniButtonTopMargin + self.view.safeAreaTop,
                                           RCCallMiniButtonLength,
                                           RCCallMiniButtonLength);
...
- (void)updateActiveTimer {
    ...
    {
        self.timeLabel.frame = CGRectMake(self.view.frame.size.width / 2 - 114.0 / 2, RCCallMiniButtonTopMargin + RCCallMiniLabelHeight + RCCallTimeTopMargin + self.view.safeAreaTop,
...
- (UILabel *)tipsLabel {
    if (!_tipsLabel) {
        ...
        _tipsLabel.textColor = [UIColor colorWithRed:0.733 green:0.753 blue:0.792 alpha:1];
...
- (RCCallTextButton *)muteButton {
    if (!_muteButton) {
        _muteButton = [[RCCallTextButton alloc] init];
...
- (RCCallTextButton *)speakerButton {
    if (!_speakerButton) {
        _speakerButton = [[RCCallTextButton alloc] init];
...
- (RCCallTextButton *)acceptButton {
    if (!_acceptButton) {
        _acceptButton = [[RCCallTextButton alloc] init];
...
- (RCCallTextButton *)hangupButton {
    if (!_hangupButton) {
        _hangupButton = [[RCCallTextButton alloc] init];
...
- (RCCallTextButton *)cameraSwitchButton {
    if (!_cameraSwitchButton) {
        _cameraSwitchButton = [[RCCallTextButton alloc] init];
    ...
    if (mediaType == RCCallMediaAudio && !isMultiCall) {
        ...
        if (callStatus == RCCallActive) {
            self.timeLabel.frame =
                CGRectMake(RCCallHorizontalMargin,
                           RCCallTopGGradientHeight + RCCallHeaderLength + RCCallTopMargin + RCCallLabelHeight + RCCallTimeTopMargin + self.view.safeAreaTop,
        ...
        if (callStatus == RCCallHangup) {
            self.tipsLabel.frame =
                CGRectMake(RCCallHorizontalMargin,
                           self.view.frame.size.height - RCCallButtonBottomMargin * 5 - self.view.safeAreaBottom,
            ...
            self.tipsLabel.frame = CGRectMake(
                ...
                RCCallButtonLength - 3.0f + self.view.safeAreaTop,
                self.view.frame.size.width - RCCallHorizontalMargin * 2, RCCallLabelHeight);
        } else {
            self.tipsLabel.frame =
            CGRectMake(RCCallHorizontalMargin,
        ...
        if (callStatus == RCCallActive) {
            self.muteButton.frame = CGRectMake(RCCallHorizontalMiddleMargin,
                                               self.view.frame.size.height - (RCCallButtonBottomMargin * 2 - RCCallInsideMargin * 2) - 13 - RCCallCustomButtonLength - self.view.safeAreaBottom,
...
//            [self layoutTextUnderImageButton:self.muteButton];
        ...
        if (callStatus == RCCallActive){
            ...
            CGRectMake(self.view.frame.size.width - RCCallHorizontalMiddleMargin - RCCallCustomButtonLength,
                       self.view.frame.size.height - (RCCallButtonBottomMargin * 2 - RCCallInsideMargin * 2) - 13 - RCCallCustomButtonLength - self.view.safeAreaBottom, RCCallCustomButtonLength,
        ...
        if (callStatus == RCCallDialing) {
            self.hangupButton.frame =
                CGRectMake((self.view.frame.size.width - RCCallButtonLength) / 2,
                           self.view.frame.size.height - (RCCallButtonBottomMargin * 2 - RCCallInsideMargin * 2 + RCCallCustomButtonLength / 2 + 1.25f) - 13 - RCCallButtonLength/2 - self.view.safeAreaBottom, RCCallButtonLength,
                           RCCallButtonLength);
//            [self layoutTextUnderBigImageButton:self.hangupButton];
            ...
            self.hangupButton.frame = CGRectMake(
                RCCallHorizontalBigMargin, self.view.frame.size.height - (RCCallButtonBottomMargin * 2 - RCCallInsideMargin * 2 + RCCallCustomButtonLength / 2 + 1.25f) - 13 - RCCallButtonLength/2 - self.view.safeAreaBottom,
...
//            [self layoutTextUnderBigImageButton:self.hangupButton];
        ...
        if (callStatus == RCCallActive) {
            self.timeLabel.frame =
                CGRectMake(RCCallHorizontalMargin, RCCallMiniButtonTopMargin + RCCallMiniLabelHeight + RCCallTimeTopMargin + self.view.safeAreaTop,
                           self.view.frame.size.width - RCCallHorizontalMargin * 2,RCCallTimeLabelHeight);
            self.timeLabel.hidden = NO;
        } else if (callStatus != RCCallHangup) {
            self.timeLabel.hidden = YES;
        ...
        if (callStatus == RCCallActive) {
            self.tipsLabel.frame =
                CGRectMake(RCCallHorizontalMargin,
                           self.view.frame.size.height - RCCallButtonBottomMargin * 3 - RCCallButtonLength -self.view.safeAreaBottom,
                           self.view.frame.size.width - RCCallHorizontalMargin * 2, RCCallLabelHeight);
        } else if (callStatus == RCCallDialing) {
...
//            [self layoutTextUnderImageButton:self.hangupButton];
            ...
            self.acceptButton.frame =
            CGRectMake(
                       self.view.frame.size.width - RCCallHorizontalBigMargin - RCCallButtonLength, self.view.frame.size.height - (RCCallButtonBottomMargin * 2 - RCCallInsideMargin * 2 + RCCallCustomButtonLength / 2 + 1.25f) - 13 - RCCallButtonLength/2 - self.view.safeAreaBottom,
                       RCCallButtonLength, RCCallButtonLength);
//            [self layoutTextUnderImageButton:self.acceptButton];
            self.acceptButton.hidden = NO;
        } else if (callStatus == RCCallActive) {
...
//            [self layoutTextUnderImageButton:self.cameraSwitchButton];
        ...
        if (callStatus == RCCallActive) {
            ...
            CGRectMake(self.view.frame.size.width - RCCallHorizontalMiddleMargin - RCCallCustomButtonLength,
                       self.view.frame.size.height - RCCallButtonBottomMargin * 4 - RCCallCustomButtonLength * 2 - 13 - RCCallHorizontalMargin - self.view.safeAreaBottom, RCCallCustomButtonLength,
                       RCCallCustomButtonLength);
...
//            [self layoutTextUnderImageButton:self.speakerButton];
        ...
        if (callStatus == RCCallActive) {
            self.cameraSwitchButton.frame = CGRectMake(
                                                       ...
                                                       RCCallMiniButtonLength + self.view.safeAreaTop, RCCallMiniButtonLength, RCCallMiniButtonLength);
            self.cameraSwitchButton.hidden = NO;
        } else if (callStatus != RCCallHangup) {
            self.cameraSwitchButton.hidden = YES;
        }
        ...
        if (callStatus == RCCallActive) {
            self.timeLabel.frame =
            CGRectMake(self.view.frame.size.width / 2 - 49.0 / 2, RCCallMiniButtonTopMargin + RCCallMiniLabelHeight + RCCallTimeTopMargin + self.view.safeAreaTop,
        ...
        if (callStatus == RCCallIncoming || callStatus == RCCallRinging) {
            ...
            self.tipsLabel.frame =
            CGRectMake(RCCallHorizontalMargin,
                       self.view.frame.size.height - RCCallButtonLength - RCCallButtonBottomMargin * 2 - RCCallButtonInsideMargin - RCCallLabelHeight - self.view.safeAreaBottom,
                       self.view.frame.size.width - RCCallHorizontalMargin * 2, RCCallLabelHeight);
        }  else {
            self.tipsLabel.frame =
                CGRectMake(RCCallHorizontalMargin,
...
//            [self layoutTextUnderBigImageButton:self.hangupButton];
        ...
        if (callStatus == RCCallActive) {
            ...
            CGRectMake(self.view.frame.size.width - RCCallHorizontalMiddleMargin - (RCCallCustomButtonLength + RCCallInsideMargin),
                       self.view.frame.size.height - (RCCallButtonBottomMargin * 2 - RCCallInsideMargin * 2) - 13 - RCCallCustomButtonLength - self.view.safeAreaBottom, RCCallCustomButtonLength + RCCallInsideMargin * 2,
                       RCCallCustomButtonLength);
//            [self layoutTextUnderImageButton:self.cameraCloseButton];
            self.cameraCloseButton.hidden = NO;
        } else if (callStatus != RCCallHangup) {
...
- (void)callDidDisconnect {
    ...
    [self toastWhenDisconnect:self.callSession.disconnectReason];
