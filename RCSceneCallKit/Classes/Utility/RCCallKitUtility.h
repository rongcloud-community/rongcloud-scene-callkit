...
#define RCCallHeaderLength 94.0f
#define RCCallButtonLength 65.0f
#define RCCallMiniButtonLength 30.0f
#define RCCallMiniButtonTopMargin 15.0f
...
// 国际化
#define RCCallKitLocalizedString(key)  [RCCallKitUtility localizedString:key]
